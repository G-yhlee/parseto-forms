...
export function createTypeEditorStore() {
  // 상태 초기화
  ...
  return {
    ...
    get originalRecord() { return state.originalRecord; },
    get hasChanges() { return state.hasChanges; },
    ...
    get listLoading() { return listLoading; },
    ...
    generateTypes() {
      ...
      const { generatedTypes, highlightedTypes } = TypeEditorService.generateTypesFromRecord(state.record);
